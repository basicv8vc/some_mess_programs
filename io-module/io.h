...
* 重定义了ostream istream以及相应的streambuf：OutBuf, InBuf
* Stream中的Read Write利用了serializer::Handler中的Write和Read, Stream是ostream和istream的底层，
* 怎么感觉InputSplit是独立的？？？
* 多线程读文件在哪里
*/
#ifndef EXSVM_IO_H_
...
namespace exsvm {
	...
	* ostream是对Stream的封装？Stream又是对Streambuffer的封装，
	* Usage example:
	* \code
	...
	public:
		...
		*/
		istream(Stream *stream,
			size_t buffer_size = (1 << 10))//1024个字节
